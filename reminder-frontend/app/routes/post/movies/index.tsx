...
export default function PostMovie() {
  ...
  return (
    <div>
         ...
         {/* Heading */}
         <PostHeading heading={'Add a Movie to your Watch List'} btnName={'Return' } link={'/movies'}/>
      ...
      >
        ...
        <div className="mt-4">
          <label htmlFor="availability" className="block font-medium text-xl mb-1">
            Availability
          </label>
          <select
            id="availability"
          ...
          {errors.availability ? (
            <p className="mt-1 text-sm text-red-300">{errors.availability}</p>
          ) : null}
        </div>
